...
function siguientePregunta() {
  document.getElementById("pregunta").innerHTML = preguntas[iterador];
  document.getElementById("op1").innerHTML = opciones[iterador][0];
  document.getElementById("op2").innerHTML = opciones[iterador][1];
  document.getElementById("op3").innerHTML = opciones[iterador][2];
  document.getElementById("op4").innerHTML = opciones[iterador][3];
  document.getElementById("op5").innerHTML = opciones[iterador][4];

  document.getElementById("barra-progreso").value =
    (iterador * 100) / preguntas.length;
}

function actualizarPuntaje(opcion) {
  let indice = opcion - 1;
  puntaje += puntajePorOpcion[iterador][indice];
